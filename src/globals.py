...
nns = [NN.MIX_FORMER, NN.XMEM, NN.CO_TRACKER, NN.CLICKSEG, NN.YOLOV8, NN.SAM2, NN.DEVELOP_DEBUG]
geometry_nn = {
    GEOMETRY_NAME.RECTANGLE: [NN.MIX_FORMER, NN.DEVELOP_DEBUG],
    GEOMETRY_NAME.POINT: [NN.CO_TRACKER, NN.DEVELOP_DEBUG],
    GEOMETRY_NAME.POLYLINE: [NN.CO_TRACKER, NN.DEVELOP_DEBUG],
    GEOMETRY_NAME.POLYGON: [NN.CO_TRACKER, NN.DEVELOP_DEBUG],
    GEOMETRY_NAME.GRAPH_NODES: [NN.CO_TRACKER, NN.DEVELOP_DEBUG],
    GEOMETRY_NAME.BITMAP: [NN.XMEM, NN.SAM2, NN.DEVELOP_DEBUG],
    GEOMETRY_NAME.SMARTTOOL: [NN.CLICKSEG, NN.SAM2, NN.DEVELOP_DEBUG],
    GEOMETRY_NAME.DETECTOR: [NN.YOLOV8, NN.DEVELOP_DEBUG],
}
